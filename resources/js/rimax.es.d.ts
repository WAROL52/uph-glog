...
type PickTypeOfArray<T extends Array> = T extends Array<infer U> ? RXState<U> : never
...
declare class RXState<TypeState= any> {
    ...
    get isArray(): boolean
    getMap: TypeState extends Array ?
...
type UseState={
    ...
    array:<T extends RXState<any[]>|Array,U=T extends RXState<Array<infer I>>?I[]:T>(value?:T)=>[RXState<U>,TypeSetArray<U>]
...
declare class FiberOfFragment<T> extends FiberOfNode$1 {
    type:"FRAGMENT"
...
declare class FiberOfText<T> extends FiberOfNode$1 {
    type:"TEXT"
...
export { FiberOfElement$1 as FiberOfElement, FiberOfFragment, FiberOfNode$1 as FiberOfNode, FiberOfText, TemplateRef as LinksOfDataInTemplateString, RXState, component, createFiber, define, html, render, template, useEffect, useEvent, useLayoutEffect, useMemo, useProps, useRef, useState };
